...
/**
 * This is the item provider adapter for a {@link Workflow.Field} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class FieldItemProvider extends OperandItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Field_datafield_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Field_datafield_feature", "_UI_Field_type"),
				 WorkflowPackage.Literals.FIELD__DATAFIELD,
				 true,
				 false,
				 true,
				 null,
