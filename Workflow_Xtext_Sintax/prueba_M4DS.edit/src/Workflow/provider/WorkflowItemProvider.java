...
public class WorkflowItemProvider 
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(WorkflowPackage.Literals.WORKFLOW__DATAPROCESSING);
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(WorkflowPackage.Literals.WORKFLOW__DATAPROCESSING,
				 WorkflowFactory.eINSTANCE.createPMMLModel()));

		newChildDescriptors.add
			(createChildParameter
				(WorkflowPackage.Literals.WORKFLOW__DATAPROCESSING,
				 WorkflowFactory.eINSTANCE.createDataProcessing()));

		newChildDescriptors.add
			(createChildParameter
				(WorkflowPackage.Literals.WORKFLOW__LINK,
				 WorkflowFactory.eINSTANCE.createLink()));
	}
